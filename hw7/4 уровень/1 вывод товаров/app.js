...
function getProductMarkup(product) {
    productsDiv.insertAdjacentHTML("beforeEnd", `<div class="product"><div>${product.name}</div><img src="${product.imageUrl}" alt=""><div>${product.price}</div><a href="https://example.com/producs/${product.id}">Подробнее</a></div>`);
}
